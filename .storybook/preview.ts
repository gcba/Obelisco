...
const headers = [
  ...
  'Componentes|Panel',
  'Componentes|Panel/Panel destacado grande horizontal/Con imagen',
  'Componentes|Panel/Panel destacado grande horizontal/Con video',
  'Componentes|Panel/Panel destacado grande vertical/Con imagen',
  'Componentes|Panel/Panel destacado grande vertical/Con video',
