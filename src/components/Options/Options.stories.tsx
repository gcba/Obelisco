  ...
  <form className="d-flex flex-row justify-content-start options-container">
    <fieldset className="dropdown show">
      ...
      <div className="dropdown-menu show">
        ...
        <label for="options-example1" className="dropdown-item">Opción 1</label>

        <input type="radio" id="options-example2" name="example1" className="sr-only" />
        <label for="options-example2" className="dropdown-item">Opción 2</label>

        <input type="radio" id="options-example3" name="example1" className="sr-only" />
        <label for="options-example3" className="dropdown-item">Opción 3</label>
      </div>
    </fieldset>
    ...
    <fieldset className="dropdown">
      ...
      <div className="dropdown-menu">
        ...
        <label for="options-example4" className="dropdown-item">Opción 4</label>

        <input type="radio" id="options-example5" name="example2" className="sr-only" />
        <label for="options-example5" className="dropdown-item">Opción 5</label>

        <input type="radio" id="options-example6" name="example2" className="sr-only" />
        <label for="options-example6" className="dropdown-item">Opción 6</label>
      </div>
    </fieldset>
    ...
    <fieldset className="dropdown">
      ...
      <div className="dropdown-menu">
        ...
        <label for="options-example7" className="dropdown-item">Opción 7</label>

        <input type="radio" id="options-example8" name="example3" className="sr-only" />
        <label for="options-example8" className="dropdown-item">Opción 8</label>

        <input type="radio" id="options-example9" name="example3" className="sr-only" />
        <label for="options-example9" className="dropdown-item">Opción 9</label>
      </div>
    </fieldset>
