...
export const FormCardValidationWithBackground = (): JSX.Element => {
  const FORMS: Form[] = [
  ...
  return (
    <div>
      <div className="row align-items-center bg-form p-5">
              ...
              <div className="col-md-3 p-2 ">
                <form className="form">
                  <div className="form-group">
                    ...
                    {assistance && <small className="form-text text-muted">{assistance}</small>}
                    <input type="date" className={`form-control ${style}`} value={val} placeholder={text} />
