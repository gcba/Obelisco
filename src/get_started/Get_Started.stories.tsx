...
export const Info = (): JSX.Element => (
  <div>
    ...
    {/* VER DOCUMENTACION */}
    <h3 id="-ver-la-documentaci-n-de-componentes-https-gcba-github-io-estandares-componentes-web-">
    ...
    {/* SIN USAR NPM */}
    <h3 id="sin-usar-npm">Sin usar npm</h3>
    <p>
    ...
    {/* COMO IMPORTARLO */}
    <h2 id="c-mo-importarlo">Cómo importarlo</h2>
    <hr />
    <p>Obelisco cuenta de dos partes principales que se pueden importar de varias formas.</p>
    <br />

    {/* ESTILOS */}
    <h3 id="estilos-css-o-sass-">Estilos (css o sass)</h3>
    <p>
      Las hojas de estilos se pueden importar tanto en <strong>sass</strong> como en <strong>css</strong> ya compilado.
      El archivo css está ubicado en <code>/dist/obelisco.css</code> y el archivo principal de sass en{' '}
    ...
    {/* TIPOGRAFIAS */}
    <h3 id="tipograf-as">Tipografías</h3>
    <p>
    ...
    {/* ICONOGRAFIA */}
    <h3 id="iconograf-a">Iconografía</h3>
    ...
    <hr />
    <p>
      <a href="https://github.com/gcba/Obelisco/wiki">En la wiki del repositorio</a> está toda la información necesaria
      para entender cómo se organizan las diferentes partes del proyecto, cómo funciona y los procesos de trabajo que
      definimos.
    </p>
    <br />

    {/* MANTENIMIENTO Y COLABORACION */}
    <h2 id="mantenimiento-y-colaboraci-n">Mantenimiento y colaboración</h2>
    <hr />
    <p>
